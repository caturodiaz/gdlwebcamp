        ...
        <div id="eventos" class="eventos clearfix">
            ...
            <div class="caja">
                  <div id="viernes" class="contenido-dia clearfix">
                      <h4>Viernes</h4>
                          ...
                          <div>
                              ...
                              <label><input type="checkbox" name="registro[]" id="conf_07" value="conf_07"><time>19:00</time> React vs. VueJS vs Angular</label>
                          ...
                          <div>
                              ...
                              <label><input type="checkbox" name="registro[]" id="sem_06" value="sem_06"><time>15:00</time> ¿Cómo utilizar SASS para mejorar tu desempeño?</label>
                          </div>
                  </div> <!--#viernes-->
                  <div id="sabado" class="contenido-dia clearfix">
                      ...
                      <div>
                            <p>Conferencias:</p>
                            <label><input type="checkbox" name="registro[]" id="conf_04" value="conf_04"><time>10:00</time> ¿Cómo crear una tienda online que venda millones en pocos días?</label>
        ...
        <div class='resumen' id="resumen">
            ...
            <div class="caja clearfix">
                <div class="extras">
                    ...
                    <div class="orden">
                        <label for="etiquetas">Paquete de 10 etiquetas 2$ <small>(HTML5, CSS3, JavaScript, ReactJs)</small></label>
                ...
                <div class="total">
                    ...
                    <input type="submit" name="submit" id="boton_registro" class="button" value="pagar">
                </div> <!--total-->
